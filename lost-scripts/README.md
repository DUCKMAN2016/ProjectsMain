...
- `Terminal-ASCII-Programs.md` - ASCII art entertainment programs (cmatrix, asciiquarium, bonsai.sh)
...
### Terminal Autostart:
- **Yakuake**: 7 tabs on boot - yazi, fzf directory finder (alt+c), eza (ctrl+c), fresh, asciiquarium, cmatrix, bonsai.sh
- **Konsole**: 7 tabs on boot - same as above
...
- ✅ Terminal emulators (Yakuake and Konsole) open with 7 configured tabs on boot
